...
#			  distClosestBaseStation,coordsClosestBaseStation = drone.getDistClosestBaseStation(self.drones)
			...
			# elif distClosestBaseStation < 20 and drone.getHeading() == "Base":
			...
			#	  # print( moveConsumption * distClosestBaseStation, " <  ", batteryLevel + 5 )
			#	  # print("Coming Backkkkk")
